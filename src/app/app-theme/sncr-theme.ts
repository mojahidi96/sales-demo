...
export const sncrTheme: Theme = {
  ...
  properties: {
    ...
    '--primaryButton': '#0077be',
    '--disableButton':'#0077be',
    '--disableBorder':'#0077be',
    '--primaryFont': '#ffffff',
